# Graph Report - TypstRAG  (2026-07-02)

## Corpus Check
- 26 files · ~11,498 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 138 nodes · 193 edges · 15 communities (13 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8a10a28d`
...
Cohesion: 0.09
Nodes (16): Example artifact, Run, TypstRAG demo, What this proves, Ponytail prompt, RAG sources for the academic paper example, Release checklist, If submitting later (+8 more)
...
## Knowledge Gaps
- **68 isolated node(s):** `typst-rag`, `Progress`, `Evidence`, `Goal`, `Commands` (+63 more)
